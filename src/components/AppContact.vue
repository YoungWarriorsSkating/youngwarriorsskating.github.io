<template>
  <div id="contact" class="bg-blue-darker pb-5">
    <div
      class="flex flex-wrap items-start justify-around justify-center md:p-4 xs:p-2"
    >
      <div class="md:w-1/3 xs:w-full text-main-black">
        <h1 class="text-amberglow font-semibold text-4xl pb-4 allCaps">
          Contact with us
        </h1>
        ...
        <div>
          ...
          >
            <img
              class="w-1/6"
              src="./../assets/phone-call-telephone-svgrepo-com.svg"
              alt="Phone"
            />
            <div class="font-bold text-xl mb-2">Call Us</div>
            <div class="font-bold text-xl mb-2">9788261156</div>
            <div class="font-bold text-xl mb-2">7871919383</div>
          </div>
          ...
          >
            <img
              class="w-1/6"
              src="./../assets/email-opened-svgrepo-com.svg"
              alt="Email"
            />
            <div class="font-bold text-xl mb-2">Email Us</div>
        ...
        <form action="#" method="post" class="" v-on:submit.prevent>
          ...
          <div class="mb-6">
            <span v-if="error.nameEmpty">
              <input
                ...
                type="text"
                placeholder="Name"
                class="w-full border border-red-light bg-grey-lightest py-4 text-main-black font-medium text-base text-center focus:bg-grey-light focus:outline-none mr-2"
              />
            ...
            <span v-else>
              <input
                ...
                type="text"
                placeholder="Name"
                class="w-full bg-grey-lightest py-4 text-main-black font-medium text-base text-center focus:bg-grey-light focus:outline-none mr-2"
              />
            </span>
          </div>
          ...
          <div class="mb-6">
            <span v-if="error.emailEmpty">
              <input
                ...
                type="text"
                placeholder="Email"
                class="w-full border border-red-light bg-grey-lightest py-4 text-main-black font-medium text-base text-center focus:bg-grey-light focus:outline-none"
              />
              <span class="text-main-black font-semibold text-xs opacity-75">
            ...
            <span v-else>
              ...
              <span v-else>
                <input
                  ...
                  type="text"
                  placeholder="Email"
                  class="w-full bg-grey-lightest py-4 text-main-black font-medium text-base text-center focus:bg-grey-light focus:outline-none"
                />
              </span>
            </span>
          </div>
          ...
          <div class="mb-6">
            <span v-if="error.messageBodyEmpty">
              <textarea
                ...
                :disabled="showLoader"
                placeholder="Message"
                class="w-full border border-red-light bg-grey-lightest py-16 text-main-black font-medium text-base text-center focus:bg-grey-light focus:outline-none"
              ></textarea>
              <span class="text-main-black font-semibold text-xs opacity-75">
            ...
            <span v-else>
              <textarea
                ...
                :disabled="showLoader"
                placeholder="Message"
                class="w-full bg-grey-lightest py-16 text-main-black font-medium text-base text-center focus:bg-grey-light focus:outline-none"
              ></textarea>
            </span>
          </div>
          ...
          <div class="w-full md:text-right xs:text-center grid-container">
            <button
              ...
              :class="[
                showLoader
                  ? 'bg-main-green px-4 py-4 rounded font-medium text-center xs:w-full text-grey'
                  : 'bg-main-green px-4 py-4 rounded font-medium text-center xs:w-full text-grey-lightest',
              ]"
            >
              Send Message
            </button>
            <img
              v-show="showLoader"
              src="./../assets/bars-scale-fade.svg"
              alt="send icon"
              class="inline-block top h-12"
            />
          </div>
    ...
    <div class="flex items-center justify-center" v-show="alert">
      <div
        class="bg-green-lightest border border-green-light text-green-dark px-12 py-3 rounded relative"
        role="alert"
      >
        <strong class="font-bold"
          >Your message has been sent successfully.</strong
        >
        <span class="absolute pin-t pin-b pin-r px-4 py-3">
          <svg
            @click="alert = false"
            class="fill-current h-6 w-6 text-red-light opacity-75"
            role="button"
