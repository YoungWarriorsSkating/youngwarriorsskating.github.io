...
Ball control,
Team strategies,
Quick turns & speed skating skills.
This helps improve balance, coordination, and stamina.
                        </p>
                    </div>
                </div>
                 <div class="flex md:flex-no-wrap xs:flex-wrap items-center justify-center mt-5">
...
Great for kids who love speed and action.
                        </p>
                    </div>
                </div>
...
🧠 Hyperactive Kids (ADHD tendencies) -> Short, structured activity sets, Engaging and high-energy drills,Focus-building games, Safe space to release energy in a positive way.
                            </p>
                        </div>
                    </div>
